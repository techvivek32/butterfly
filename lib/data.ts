...
export const SOLUTION_TABS = [
  ...
  },
  {
    ...
    blurb:
      "Follow up automatically across every channel and never let a lead go cold.",
    features: [
      "Email Marketing",
      "2-Way SMS Marketing",
  ...
  },
  {
    key: "close",
    label: "Close",
    heading: "Close deals on autopilot",
    blurb:
      "Book appointments, collect payments and sign documents — all in one flow.",
    features: [
  ...
  },
  {
    ...
    blurb:
      "Collect reviews, run referrals and build communities that grow themselves.",
    features: [
  ...
  },
  {
    key: "reactivate",
    label: "Reactivate",
    heading: "Win back lost revenue",
    blurb:
      "Re-engage cold contacts and database leads with AI-powered campaigns.",
    features: [
